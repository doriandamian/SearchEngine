...
class FileCrawler:
    def __init__(self, root_dir = "/Users/doriandamian", ignoredDirs = [".git", "__pycache__", "Applications", "Parallels", "Library"]):
        ...
        for dirPath, dirNames, fileNames in os.walk(self.root_dir):
            ...
            for file in fileNames:
                ...
                if not os.path.exists(filePath):
                    logger.addLog(f"File {filePath} does not exist or is a broken link. Skipping.")
                    continue
